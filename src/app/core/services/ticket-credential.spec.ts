...
describe('TicketCredentialService', () => {
  ...
  it('creates a credential with only the login', () => {
    ...
    const request = http.expectOne('/v1/gem-clientes/admin/clientes/42/credenciales');
  ...
  it('updates a credential with a partial payload', () => {
    ...
    const request = http.expectOne('/v1/gem-clientes/admin/clientes/42/credenciales/credential-1');
  ...
  it('rotates a credential by id', () => {
    ...
    const request = http.expectOne('/v1/gem-clientes/admin/clientes/42/credenciales/credential-1/rotate');
    expect(request.request.method).toBe('POST');
